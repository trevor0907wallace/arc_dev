...
export const profile = {
  ...
  tagline:
    'I take web applications from architecture to production. That means the interface, the services behind it, and the infrastructure it runs on.',
  summary:
...
export const stats = [
  ...
  { value: 'AI native', label: 'Claude and OpenAI systems' },
] as const
...
export const expertise: Expertise[] = [
  {
    ...
    blurb:
      'Retrieval-augmented assistants on the Claude and OpenAI APIs, with vector search, semantic retrieval, and conversational interfaces that let people query internal knowledge in plain language.',
  },
  {
...
export const experience: Role[] = [
  {
    ...
    location: 'Raleigh, NC',
    highlights: [
      'Owned client engagements end to end as technical lead and project manager, from scoping and architecture through delivery and support, and stayed the point of contact for stakeholders.',
      'Built AI-powered features into customer-facing products. A retrieval-augmented assistant with a Python and FastAPI backend, a vector database for semantic search, and a React interface that cut support lookup time noticeably.',
      'Delivered across the full stack, with React and Next.js on the frontend and Python, FastAPI, and Node services behind them, along with the API design, authentication, and data models underneath.',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Took on the harder, less-defined problems, from performance bottlenecks to third-party integrations and features with no clear starting point, and saw them through to production.',
    ],
  },
  {
...
export const skills: SkillGroup[] = [
  {
    title: 'Languages',
    items: ['Python', 'TypeScript', 'JavaScript', 'Java', 'C#', 'SQL', 'HTML5', 'CSS'],
  },
  {
    title: 'Frontend',
    items: [
